...
class SMSController extends Controller
{
    ...
    public function index()
    {
        ...
        $log = add_log('info','Viewing sms template details.',$moduleId,Auth::user()->id,getDateTime());
    ...
    public function storeSMSTemplate(Request $request)
    {
        ...
        try {
            ...
            //Adding Log Data.
            $log = add_log('info','Failed to store sms template ->'.$e,$moduleId,Auth::user()->id,getDateTime());
            return redirect()->route('sms.templates')->with('error','Failed to add SMS template.');
        }
    }
    ...
    public function updateSMSTemplate(Request $request, $id)
    {
        ...
        try {
            ...
            if($template->save()) {
                //Adding Log Data.
                $log = add_log('info','SMS template update successfully.',$moduleId,Auth::user()->id,getDateTime());
            ...
            //Adding Log Data.
            $log = add_log('error','Failed to update sms template ->'.$e,$moduleId,Auth::user()->id,getDateTime());
            return redirect()->route('sms.templates')->with('error','Failed to update SMS template.');
        }
    }
