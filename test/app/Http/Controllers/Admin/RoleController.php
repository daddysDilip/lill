...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        $log = add_log('info','View role details.',$moduleId,Auth::user()->id,getDateTime());
    ...
    public function createRole()
    {
        ...
        $log = add_log('info','View add role form.',$moduleId,Auth::user()->id,getDateTime());
    ...
    public function storeRole(Request $request)
    {
        ...
        try {
            if(Roles::where(['name'=>$request->input('role')])->first()) {
                ...
                if($role->save()) {
                    //Adding Log Data.
                    $log = add_log('info','Role added successfully.',$moduleId,Auth::user()->id,getDateTime());
                    return redirect()->route('roles')->with('success','Role added successfully.');    
                } else {
                    //Adding Log Data.
                    $log = add_log('error','Failed to add role.',$moduleId,Auth::user()->id,getDateTime());
                    return redirect()->route('roles')->with('error','Failed to add role.');    
                }
            }
        } catch (Exception $e) {
            $log = add_log('error','Failed to add role ->'.$e,$moduleId,Auth::user()->id,getDateTime());
            return redirect()->route('roles')->with('error','Failed to add role.');
        }
    }
    ...
    public function editRole($id)
    {
        ...
        $log = add_log('info','Viewing role edit form.',$moduleId,Auth::user()->id,getDateTime());
    ...
    public function updateRole(Request $request, $id)
    {
        ...
        try {
            ...
            if($role->save()) {
                $log = add_log('info','Role updated successfully.',$moduleId,Auth::user()->id,getDateTime());
                return redirect()->route('roles')->with('success','Role updated successfully.');    
            } else {
                return redirect()->route('roles')->with('error','Failed to update role.');    
            }
        } catch (Exception $e) {
            $log = add_log('error','Failed to update role ->'.$e,$moduleId,Auth::user()->id,getDateTime());
            return redirect()->route('roles')->with('error','Failed to update role.');    
        }
    }
