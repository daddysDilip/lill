                                    ...
                                    @endif
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-12">
                                                    <div class="form-group">
                                                        <label for="first-name-vertical">Feature Heading</label>
                                                        <input type="text" id="heading"  class="form-control" value="{{$Feature->heading ?? ''}}" {{(!empty($Feature->heading) ? "readonly" : "")}} name="heading" placeholder="Enter feature heading">
                                                    </div>
                                                </div>
