...
class ModuleController extends Controller
{
    ...
    public function index()
    {
        ...
        $log = !empty($moduleId) ? add_log('info','View modules detail.',$moduleId,Auth::guard('admin')->user()->id,getDateTime()) : '';
    ...
    public function createModule()
    {
        ...
        $log = !empty($moduleId) ? add_log('info','View create module form.',$moduleId,Auth::guard('admin')->user()->id,getDateTime()) : "";
        ...
        try {
            if(Modules::where(['name'=>$request->input('module')])->first()) {
                ...
                if($module->save()) {
                    ...
                    //Adding Log Data.
                    $log = !empty($moduleId) ? add_log('info','Inserting new module.',$moduleId,Auth::guard('admin')->user()->id,getDateTime()) : "";
            ...
            //Adding Log Data.
            $log = !empty($moduleId) ? add_log('info','Failed to insert module ->'.$e,$moduleId,Auth::guard('admin')->user()->id,getDateTime()) : "";
            return redirect()->route('modules')->with('error','Failed to add module.');    
        }
    ...
    public function editModule($id)
    {
        ...
        $log = !empty($moduleId) ? add_log('info','View edit module form.',$moduleId,Auth::guard('admin')->user()->id,getDateTime()) : "";
    ...
    public function updateModule(Request $request, $id)
    {
        ...
        try {
            ...
            if($module->save()) {
                //Adding Log Data.
                $log = !empty($moduleId) ? add_log('info','Module udpated successfully.',$moduleId,Auth::guard('admin')->user()->id,getDateTime()) : "";
            ...
            //Adding Log Data.
            $log = !empty($moduleId) ? add_log('info','Failed to udpate module ->'.$e,$moduleId,Auth::guard('admin')->user()->id,getDateTime()) : "";
