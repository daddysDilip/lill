                ...
                <div class="col-xl-9 col-sm-9 col-12">
                    <div class="row">
                        <div class="col-lg-3 col-sm-6 col-12">
                            ...
                            <div class="footer-links">
                                <ul>
                                    ...
                                    <li><a href="{{route('cookie.and.policy')}}">Cookie Policy</a></li>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            ...
                            <div class="footer-links">
                                <ul>
                                    <?php if(!empty(get_setting_option('email')->value)) { ?><li><a href="mailto:{{get_setting_option('email')->value}}">E: info@lill.pw</a></li><?php } ?>
                                    <?php if(!empty(get_setting_option('contact_number')->value)) { ?><li><a href="tel:{{get_setting_option('contact_number')->value}}">P: 1855 448 7363</a></li><?php } ?>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 col-12 text-center text-lg-left copyright pt-4">
                    Copyright &copy; {{date('Y')}} All Rights Reserved. Developed by: <a href="https://daddyscode.com/" target="_blank" title="">DaddysCode</a>
                </div>
                <div class="col-lg-4 col-12 text-center text-md-right pt-4">
                    <ul class="social-follow margin-2-top d-flex justify-content-center justify-content-lg-end">
                        <?php if(!empty(get_setting_option('facebook_link')->value)) { ?><li><a target="_blank" title="Facebook" href="https://www.facebook.com/daddyscodesocial/"><i class="sprite fb-follow"></i></a></li><?php } ?>
                        <?php if(!empty(get_setting_option('twitter_link')->value)) { ?><li><a target="_blank" title="Twitter" href="https://twitter.com/daddyscode?lang=en" ><i class="sprite tw-follow"></i></a></li><?php } ?>
                    </ul>
                </div>
