        ...
        <div class="container">
            <div class="row">
                <div class="col-3">
                    ...
                    <a class="nav-link p-3 {{!empty($tab) && $tab == 'favorite-links' ? 'active' : ''}}" id="v-pills-favorite-tab" href="{{route('user.account.settings','favorite-links')}}" role="tab" aria-controls="v-pills-favorite" aria-selected="false">Favorite Links</a>
                    </div>
                </div>
                <div class="col-9">
                    <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="link-details p-2 p-lg-3">
                                ...
                                <div class="row mt-5">
                                    <div class="col-xs-6 mt-4">
                                        <span class="sub-title ml-3 p-5">FREE ACCOUNT</span>
                                    </div>
                                ...
                                <div class="row mt-5">
                                    ...
                                    @csrf
                                        <table class="table table-condensed ml-3">
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <div class="form-group text-right button-block" style="display: none;">
                                ...
                                <div class="row mt-5">
                                    <table class="table table-condensed ml-3">
                                        <tr>
                                            <th colspan="2"><h1>MONTHLY USAGE</h1></th>
                                        </tr>
                                        <tr>
                                            <td width="20%">Total Links</td>
                                            <td width="80%"><div id="total-links-progress" class="text-center" data-total_links="{{$TotalLinks ?? ''}}"><span>{{$TotalLinks ?? ''}} / 1000</span></div></td>
                                        </tr>
                                    </table>  
                                </div>
                            </div>
                                ...
                                <div class="container mt-5">
                                    ...
                                    <form action="{{route('change.user.password')}}" id="ChangePassword" method="post">
                                        ...
                                        <div class="form-group row">
                                            <label for="old_password" class="col-sm-2 col-form-label">Old Password <span class="text-danger"></span></label>
                                            <div class="col-lg-10">
                        ...
                        <div class="tab-pane fade show {{!empty($tab) && $tab == 'favorite-links' ? 'active' : ''}}" id="v-pills-favorite" role="tabpanel" aria-labelledby="v-pills-favorite-tab">
                            <div class="link-details p-2 p-lg-3">
                                <h1 class="account-title">Favorite Links</h1>
                                <div class="row mt-5">
                                    <table class="table ml-3">
                                        <thead>
                                            <tr>
