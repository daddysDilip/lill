...
<div class="url-sec pt-5 pb-5">
        <div class="pb-5 d-none d-md-block"></div>
            <div class="col-lg-6 text-center offset-lg-3">
                <h1 class="heading-s1">
                    Easiest Way To Create, Manage & Promote
                    <br/> Short Meaningful URLs
                </h1>
            ...
            <div class="container">
                <div class="bg-white box-shadow pt-3 pl-3 pr-3 pb-4 pt-lg-5 pl-lg-5 pr-lg-5">
                    ...
                    <p class="text-center pt-4">By clicking SHORTEN, you are agreeing to lill’s <a
                            class="theme-color" href="#"><u>Terms of Service</u></a> and <a class="theme-color"
                ...
                <div class="row">
                    <div class="col-lg-4 text-center mb-5">
                        <div class="bg-white p-4 rounded box-shadow">
                            ...
                            <h2 class="heading-s2 mt-4">Get Short URL(Optimize)</h2>
                            <p>
                    ...
                    <div class="col-lg-4 text-center mb-5">
                        <div class="bg-white p-4 rounded box-shadow">
                            ...
                            <h2 class="heading-s2 mt-4">Scale Your Business(Analyze)</h2>
                            <p>
                    ...
                    <div class="col-lg-4 text-center mb-5">
                        <div class="bg-white p-4 rounded box-shadow">
                            ...
                            <h2 class="heading-s2 mt-4">Brand Your Self(Promote)</h2>
                            <p>
            ...
            <div class="container pb-5">
                <div class="row align-items-center">
                    <div class="col-lg-5 mb-3">
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <a href="{{url('signup')}}" class="btn btn-theme p-1 pl-4 pr-4">Create Account</a>
                            </div>
                            <div class="col-auto">
                                <a href="#" data-toggle="modal" data-target="#GetCallModal" class="theme-color">Get a Quote</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="tracking-sec third pt-5 pb-lg-5">
            <div class="container pt-lg-2 pb-lg-2 pt-lg-5 pb-lg-5">
                <div class="row align-items-center">
                    <div class="col-lg-5 mb-3">
                        <h3 class="heading-s1 mb-3">
                            Show Premier Service (Select Vanity Domains for Brand Promotion)
                        </h3>
                        <p>
